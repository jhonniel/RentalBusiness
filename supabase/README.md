...
5. Later phase files through `20260913270000_google_oauth_profile_names.sql` — availability, rental, waiver, payment, receipt, hardening, admin QR payment methods, availability calendar, privacy-policy acknowledgments, Terms & Conditions acknowledgments, and Google OAuth profile names
