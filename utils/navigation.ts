...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'Calendar', icon: 'i-lucide-calendar', enabled: false },
  ...
  { label: 'Sales', icon: 'i-lucide-trending-up', enabled: false },
  ...
  { label: 'Settings', icon: 'i-lucide-settings', enabled: false },
  { label: 'Audit Logs', icon: 'i-lucide-scroll-text', enabled: false },
]
